...
```bash
spl run cookbook/12_plan_and_execute/plan_execute.spl --adapter ollama -m qwen2.5-coder task=Build a REST API for a todo app output_dir=cookbook/12_plan_and_execute/output max_steps=4
```
