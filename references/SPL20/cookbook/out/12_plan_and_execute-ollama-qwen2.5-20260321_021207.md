...
-- Count how many steps are in the plan
CREATE FUNCTION count_steps(plan TEXT) RETURNS TEXT AS $$
Count the number of numbered steps in this plan and return ONLY the integer.
