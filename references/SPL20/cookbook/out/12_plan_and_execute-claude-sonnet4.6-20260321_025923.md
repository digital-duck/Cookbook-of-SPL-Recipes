...
```bash
spl run cookbook/12_plan_and_execute/plan_execute.spl --adapter claude_cli -m claude-sonnet-4-6 task=Build a REST API for a todo app output_dir=cookbook/12_plan_and_execute/output max_steps=4
```
