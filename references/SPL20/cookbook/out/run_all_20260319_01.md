...
[01] Hello World
     cmd : spl run ./01_hello_world/hello.spl --adapter ollama -m gemma3
...
[02] Ollama Proxy
     cmd : spl run ./02_ollama_proxy/proxy.spl --adapter ollama prompt=Explain quantum computing in one sentence -m gemma3
...
[03] Multilingual Greeting
     cmd : spl run ./03_multilingual/multilingual.spl --adapter ollama user_input=hello wen lang=Chinese -m gemma3
...
[05] Self-Refine
     cmd : spl run ./05_self_refine/self_refine.spl --adapter ollama task=Write a haiku about coding -m gemma3
...
[06] ReAct Agent
     cmd : spl run ./06_react_agent/react_agent.spl --adapter ollama task=What is the population of France? -m gemma3
...
[07] Safe Generation
     cmd : spl run ./07_safe_generation/safe_generation.spl --adapter ollama prompt=Explain how encryption works -m gemma3
...
[08] RAG Query
     cmd : spl run ./08_rag_query/rag_query.spl --adapter ollama question=What language is best for systems programming? -m gemma3
...
[09] Chain of Thought
     cmd : spl run ./09_chain_of_thought/chain.spl --adapter ollama topic=distributed AI inference -m gemma3
...
[11] Debate Arena
     cmd : spl run ./11_debate_arena/debate.spl --adapter ollama topic=AI should be open-sourced -m gemma3
...
[12] Plan and Execute
     cmd : spl run ./12_plan_and_execute/plan_execute.spl --adapter ollama task=Build a REST API for a todo app -m gemma3
...
[13] Map-Reduce Summarizer
     cmd : spl run ./13_map_reduce/map_reduce.spl --adapter ollama document=The quick brown fox jumps over the lazy dog. This is a test document for map-reduce summarization. style=bullet points -m gemma3
...
[14] Multi-Agent Collaboration
     cmd : spl run ./14_multi_agent/multi_agent.spl --adapter ollama topic=Impact of AI on healthcare -m gemma3
...
[15] Code Review
     cmd : spl run ./15_code_review/code_review.spl --adapter ollama code=def foo(x): return eval(x) language=Python -m gemma3
...
[16] Reflection Agent
     cmd : spl run ./16_reflection/reflection.spl --adapter ollama problem=Design a URL shortener system -m gemma3
...
[17] Tree of Thought
     cmd : spl run ./17_tree_of_thought/tree_of_thought.spl --adapter ollama problem=Should we rewrite the legacy system or incrementally refactor? -m gemma3
...
[18] Guardrails Pipeline
     cmd : spl run ./18_guardrails/guardrails.spl --adapter ollama user_input=Explain how encryption works -m gemma3
...
[19] Memory Conversation
     cmd : spl run ./19_memory_conversation/memory_chat.spl --adapter ollama user_input=My name is Alice and I am a data scientist -m gemma3
...
[20] Ensemble Voting
     cmd : spl run ./20_ensemble_voting/ensemble.spl --adapter ollama question=What causes inflation? -m gemma3
...
[21] Multi-Model Pipeline
     cmd : spl run ./21_multi_model_pipeline/multi_model.spl --adapter ollama topic=climate change -m gemma3
