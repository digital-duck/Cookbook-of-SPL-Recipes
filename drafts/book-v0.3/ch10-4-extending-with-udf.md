...
## Recipe 36 — The Definitive Example

Recipe 36 (Tool-Use / Function-Call) is the reference implementation of the UDF pattern. It embodies the core architectural principle:
...
Recipe 18 (Guardrails Pipeline) shows UDFs doing exactly what an LLM should not: deterministic pattern matching.
