...
The Safe Generation recipe (Recipe 07) implements this as a "Self-Correction Loop." It generates a response, uses an "LLM-as-Judge" to evaluate the quality, and then branches to different outcomes based on the verdict. It also demonstrates SPL 2.0's advanced `EXCEPTION` handling for generative risks.
