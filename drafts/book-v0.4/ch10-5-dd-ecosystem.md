...
**SPL use:** Recipe 17 (Chat Over PDF) and future document-processing recipes will use `dd-extract` to pull text out of PDFs before indexing them with `spl doc-rag add`.
