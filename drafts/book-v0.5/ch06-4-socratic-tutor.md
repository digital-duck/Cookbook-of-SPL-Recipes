...
<!-- *"The highest form of teaching is not giving answers, but asking the right questions." — Wen Gong* -->
...
The Socratic Tutor recipe (section 6.4) simulates this dialogue. It doesn't just ask questions; it **simulates** a student's responses to test its own effectiveness, scores the student's emerging understanding, and adapts its questioning strategy in real-time.
