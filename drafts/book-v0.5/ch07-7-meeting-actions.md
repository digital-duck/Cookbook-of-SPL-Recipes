...
The Meeting Actions recipe (section 8.8) implements this pipeline. it shows how SPL can manage "Long-Form" context by breaking the task into speaker identification, action extraction, and date normalization phases.
