...
The Plan and Execute recipe (section 2.3) is the most advanced workflow in the basics section. It demonstrates how to use nested `WHILE` loops and `EVALUATE` logic to manage a multi-file software project from start to finish.
