...
The Multi-Model Pipeline recipe (section 2.5) demonstrates this "Best-of-Breed" orchestration. It routes research, analysis, and writing to the models most suited for those roles, then wraps them in a quality-control loop.
