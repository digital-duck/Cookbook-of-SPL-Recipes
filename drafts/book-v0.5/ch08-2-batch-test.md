...
<!-- *"Don't just run it once; run it until it breaks, then run it again." — Wen Gong* -->
...
In section 1.4 (Model Showdown), we fanned out one prompt to three models. Here, we are fanning out **three different recipes** across **two models each**—a total of six parallel branches. 
...
1.  **Add a 4th Recipe.** Modify the workflow to include section 2.1 (Self-Refine) in the batch test.
