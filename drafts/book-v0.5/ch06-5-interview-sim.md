...
<!-- *"To master a skill, you must first survive the simulation." — Wen Gong* -->
...
The Interview Sim recipe (section 6.5) implements this triad. It allows you to simulate technical interviews for any role (Senior SWE, Data Scientist, etc.) and provides a structured evaluation report that highlights strengths and weaknesses.
