...
<!-- *"The only thing better than a good prompt is a proven prompt." — Wen Gong* -->
...
The A/B Test recipe (section 9.3) implements this optimization loop. It can load pre-built experiments from an `experiments.json` file or accept ad-hoc prompt variants from the command line.
