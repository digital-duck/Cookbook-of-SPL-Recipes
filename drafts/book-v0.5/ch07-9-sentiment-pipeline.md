...
<!-- *"Data tells you what happened; sentiment tells you why it matters." — Wen Gong* -->
...
The Sentiment Pipeline recipe (section 8.10) implements this full stack. It demonstrates the **80/20 Rule** perfectly: LLMs do the hard work of "feeling" the text, while Python does the heavy lifting of "calculating" the statistics.
