...
The Hypothesis Tester recipe (section 3.3) implements this rigorous loop. It forces the model to think like a scientist—identifying variables and seeking evidence that *refutes* its own initial guess before reaching a final verdict.
