...
<!-- *"Code without tests is just a bug waiting to happen." — Wen Gong* -->
...
The Code Gen + Tests recipe (section 8.9) implements this robust lifecycle. It allows you to specify a task (e.g., "Binary search") and a language (e.g., "Go"), and it handles all the details of formatting, conventions, and test framework selection automatically.
