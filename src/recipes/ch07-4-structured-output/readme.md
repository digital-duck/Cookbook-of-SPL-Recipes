...
# Local Ollama
spl run src/recipes/ch07-4-structured-output/structured_output.spl --adapter ollama -m gemma3 \
    text="John Smith, 42, joined Acme Corp in March 2021 earning \$95,000/year"

# Momagrid
spl run src/recipes/ch07-4-structured-output/structured_output.spl --adapter momagrid -m gemma3 \
    text="John Smith, 42, joined Acme Corp in March 2021 earning \$95,000/year"

# Extract invoice fields
# Local Ollama
spl run src/recipes/ch07-4-structured-output/structured_output.spl --adapter ollama \
    text="Invoice #INV-2045 from TechSupplies Ltd dated 15 Jan 2024 for \$3,420.50 due in 30 days"

# Momagrid
spl run src/recipes/ch07-4-structured-output/structured_output.spl --adapter momagrid \
    text="Invoice #INV-2045 from TechSupplies Ltd dated 15 Jan 2024 for \$3,420.50 due in 30 days"
```
