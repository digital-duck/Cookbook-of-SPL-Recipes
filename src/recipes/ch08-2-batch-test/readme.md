...
# Local Ollama
spl run src/recipes/ch08-2-batch-test/batch_test.spl --adapter ollama

# Momagrid
spl run src/recipes/ch08-2-batch-test/batch_test.spl --adapter momagrid
...
bash src/recipes/ch08-2-batch-test/batch_test.sh

# Single model
MODELS="gemma3" bash src/recipes/ch08-2-batch-test/batch_test.sh

# Dry run with echo adapter (no Ollama needed)
ADAPTER=echo bash src/recipes/ch08-2-batch-test/batch_test.sh

# Custom model set
MODELS="gemma3 llama3.2 phi3" bash src/recipes/ch08-2-batch-test/batch_test.sh \
    2>&1 | tee src/recipes/ch08-2-batch-test/out/10_batch_test-$(date +%Y%m%d_%H%M%S).md
```
...
>>> Model: gemma3
----------------------------------------------
  PASS  ch01-1-hello-world/hello.spl
  PASS  ch01-2-ollama-proxy/proxy.spl
  PASS  ch01-3-multilingual/multilingual.spl
