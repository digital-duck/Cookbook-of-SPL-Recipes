# ch07-6: Customer Support Triage
...
# Local Ollama
spl run src/recipes/ch07-6-support-triage/support_triage.spl \
    --adapter ollama -m gemma3 \
    --tools src/recipes/ch07-6-support-triage/tools.py \
    ticket="My account has been charged twice for the same order #ORD-12345" \
    2>&1 | tee src/recipes/ch07-6-support-triage/out/28_support_triage-$(date +%Y%m%d_%H%M%S).md
...
spl run src/recipes/ch07-6-support-triage/support_triage.spl \
    ...
    --tools src/recipes/ch07-6-support-triage/tools.py \
    ticket="My account has been charged twice for the same order #ORD-12345" \
    2>&1 | tee src/recipes/ch07-6-support-triage/out/28_support_triage-momagrid-$(date +%Y%m%d_%H%M%S).md
