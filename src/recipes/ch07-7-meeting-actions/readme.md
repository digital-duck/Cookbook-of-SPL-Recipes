# ch07-7: Meeting Notes → Action Items
...
# Local Ollama
spl run src/recipes/ch07-7-meeting-actions/meeting_actions.spl \
    --adapter ollama -m gemma3 \
    --tools src/recipes/ch07-7-meeting-actions/tools.py \
    filename=sprint_planning.txt \
    output_format=markdown \
    2>&1 | tee src/recipes/ch07-7-meeting-actions/out/29_meeting_actions-$(date +%Y%m%d_%H%M%S).md
...
spl run src/recipes/ch07-7-meeting-actions/meeting_actions.spl \
    ...
    filename=sprint_planning.txt \
    output_format=markdown \
    2>&1 | tee src/recipes/ch07-7-meeting-actions/out/29_meeting_actions-momagrid-$(date +%Y%m%d_%H%M%S).md
