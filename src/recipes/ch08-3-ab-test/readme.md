...
# Local Ollama
spl run src/recipes/ch08-3-ab-test/ab_test.spl \
    --adapter ollama -m gemma3 \
    --tools src/recipes/ch08-3-ab-test/tools.py \
    experiment_id=neural_networks \
    2>&1 | tee src/recipes/ch08-3-ab-test/out/26_ab_test-$(date +%Y%m%d_%H%M%S).md
...
spl run src/recipes/ch08-3-ab-test/ab_test.spl \
    ...
    --tools src/recipes/ch08-3-ab-test/tools.py \
    experiment_id=neural_networks \
    2>&1 | tee src/recipes/ch08-3-ab-test/out/26_ab_test-momagrid-$(date +%Y%m%d_%H%M%S).md
