...
# Local Ollama
spl run src/recipes/ch02-6-nested-procedures/nested_procs.spl --adapter ollama -m gemma3 \
    topic="quantum computing" audience="high school students"

# Momagrid
spl run src/recipes/ch02-6-nested-procedures/nested_procs.spl --adapter momagrid -m gemma3 \
    topic="quantum computing" audience="high school students"

# Deep-dive for policy makers
# Local Ollama
spl run src/recipes/ch02-6-nested-procedures/nested_procs.spl --adapter ollama \
    topic="CRISPR gene editing" audience="policy makers" depth="deep"

# Momagrid
spl run src/recipes/ch02-6-nested-procedures/nested_procs.spl --adapter momagrid \
    topic="CRISPR gene editing" audience="policy makers" depth="deep"
