...
| `log_dir` | TEXT | `'src/recipes/ch06-3-ensemble-voting/logs'` | Directory for per-step log files |
...
```bash
# Local Ollama
spl run src/recipes/ch06-3-ensemble-voting/ensemble.spl --adapter ollama \
    question="What causes inflation?"

# Momagrid
spl run src/recipes/ch06-3-ensemble-voting/ensemble.spl --adapter momagrid \
    question="What causes inflation?"
```
...
# Local Ollama
spl run src/recipes/ch06-3-ensemble-voting/ensemble_v2.spl \
    --adapter ollama \
    --tools src/recipes/ch06-3-ensemble-voting/tools.py \
    question="What causes inflation?"
...
All written to `@log_dir` (default: `src/recipes/ch06-3-ensemble-voting/logs/`):
