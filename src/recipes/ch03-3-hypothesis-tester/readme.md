...
```bash
# Local Ollama
spl run src/recipes/ch03-3-hypothesis-tester/hypothesis.spl --adapter ollama \
...
spl run src/recipes/ch03-3-hypothesis-tester/hypothesis.spl --adapter ollama -m llama3.2 \
    observation="Daily standups reduce sprint velocity by 10%" \
    domain="management"

# Momagrid
spl run src/recipes/ch03-3-hypothesis-tester/hypothesis.spl --adapter momagrid \
    observation="Remote teams show lower productivity in the first month after joining"
...
spl run src/recipes/ch03-3-hypothesis-tester/hypothesis.spl --adapter momagrid -m llama3.2 \
    observation="Daily standups reduce sprint velocity by 10%" \
    domain="management"
```
