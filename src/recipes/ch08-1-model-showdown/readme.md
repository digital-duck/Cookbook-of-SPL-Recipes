...
```bash
# Local Ollama
spl run src/recipes/ch08-1-model-showdown/showdown.spl --adapter ollama \
...
# Momagrid
spl run src/recipes/ch08-1-model-showdown/showdown.spl --adapter momagrid \
    prompt="What is the meaning of life?"
...
```bash
# Local Ollama
spl run src/recipes/ch08-1-model-showdown/showdown.spl --adapter ollama prompt="Write a poem about Spring season" model_1=gemma3 model_2=phi3 model_3=qwen2.5

# Momagrid
spl run src/recipes/ch08-1-model-showdown/showdown.spl --adapter momagrid prompt="Write a poem about Spring season" model_1=gemma3 model_2=phi3 model_3=qwen2.5
```
