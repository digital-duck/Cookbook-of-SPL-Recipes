...
```bash
# Local Ollama
spl run src/recipes/ch02-5-multi-model-pipeline/multi_model.spl --adapter ollama \
...
# Momagrid
spl run src/recipes/ch02-5-multi-model-pipeline/multi_model.spl --adapter momagrid \
    topic="climate change"
