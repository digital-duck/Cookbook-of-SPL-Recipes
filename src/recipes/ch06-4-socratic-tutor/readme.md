...
# Local Ollama
spl run src/recipes/ch06-4-socratic-tutor/socratic_tutor.spl \
    --adapter ollama -m gemma3 \
    --tools src/recipes/ch06-4-socratic-tutor/tools.py \
    topic_id=sky_blue subject=science student_level="middle school" \
    2>&1 | tee src/recipes/ch06-4-socratic-tutor/out/32_socratic-$(date +%Y%m%d_%H%M%S).md
...
spl run src/recipes/ch06-4-socratic-tutor/socratic_tutor.spl \
    ...
    --tools src/recipes/ch06-4-socratic-tutor/tools.py \
    topic_id=sky_blue subject=science student_level="middle school" \
    2>&1 | tee src/recipes/ch06-4-socratic-tutor/out/32_socratic-momagrid-$(date +%Y%m%d_%H%M%S).md
