...
# Local Ollama
spl run src/recipes/ch06-5-interview-sim/interview_sim.spl \
    --adapter ollama -m gemma3 \
    --tools src/recipes/ch06-5-interview-sim/tools.py \
    role_key=senior_swe focus=system_design candidate_id=alice_senior_swe difficulty=hard \
    2>&1 | tee src/recipes/ch06-5-interview-sim/out/33_interview_sim-$(date +%Y%m%d_%H%M%S).md
...
spl run src/recipes/ch06-5-interview-sim/interview_sim.spl \
    ...
    --tools src/recipes/ch06-5-interview-sim/tools.py \
    role_key=senior_swe focus=system_design candidate_id=alice_senior_swe difficulty=hard \
    2>&1 | tee src/recipes/ch06-5-interview-sim/out/33_interview_sim-momagrid-$(date +%Y%m%d_%H%M%S).md
