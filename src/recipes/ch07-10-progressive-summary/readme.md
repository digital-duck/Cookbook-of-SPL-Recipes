# ch07-10: Progressive Summarizer
...
```bash
# Local Ollama
spl run src/recipes/ch07-10-progressive-summary/progressive_summary.spl --adapter ollama \
...
# Momagrid
spl run src/recipes/ch07-10-progressive-summary/progressive_summary.spl --adapter momagrid \
    text="$(cat long_article.txt)"
